...
const getUserProfile = async (accessToken) => {
    const response = await fetch(process.env.REACT_APP_GRAPH_MICROSOFT, {
    ...
    useEffect(() => {
        const fetchUserProfileAndData = async () => {
            ...
            try {
                ...
                localStorage.setItem('7#4^>3%&', x5t.data);
        ...
        const handleUserProfile = async (userProfile, x5t) => {
            //const codeId = '600010'; //660105 เดฟ //400129 พี่เอ๋ //340044 พี่พงษ์ //610117 พี่ต๊าส //600010 พี่โจ้  //320101 พี่ประกอบ
